...
# ml load system && ml load git-lfs/2.4.0 && huggingface-cli lfs-enable-largefiles .
...
# run interactive job with  srun --partition=deho --gpus=2 -C GPU_SKU:A100_SXM4 --mem=256G --time=02:00:00 --pty /bin/bash
